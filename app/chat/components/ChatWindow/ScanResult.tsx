                ...
                <Card className="bg-card">
                  <CardHeader>
                    <CardTitle className="text-lg sm:text-xl">
                      Vendor Analysis Distribution
                    </CardTitle>
                    <CardDescription>
                      Breakdown of security vendor assessments
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ChartContainer
              ...
              <Card className="bg-card">
                <CardHeader>
                  <div className="flex items-center space-x-2">
                    ...
                    <CardTitle className="text-lg sm:text-xl">
                      {scanned_output.privacy_risk.header}
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-card">
                <CardHeader>
                  <div className="flex items-center space-x-2">
                    ...
                    <CardTitle className="text-lg sm:text-xl">
                      {scanned_output.security.header}
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-card">
                <CardHeader>
                  <div className="flex items-center space-x-2">
                    ...
                    <CardTitle className="text-lg sm:text-xl">
                      {scanned_output.data_sharing.header}
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
